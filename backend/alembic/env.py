...
Runs migrations against the database configured in ``app.config``. Because
PhotoPi uses an async SQLAlchemy engine, online migrations are executed
...
from app import models  # noqa: F401,E402  - registers all ORM models
